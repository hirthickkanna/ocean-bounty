...
if(isset($_POST['submit']))
  ...
  // Query for data insertion
     $query=mysqli_query($con, "insert into tblusers(FirstName,date, MobileNumber, Email, Address,time) value('$fname','$lname', '$contno', '$email', '$add' ,'$time')");
    if ($query) {
    echo "<script>alert('You have successfully inserted the data');</script>";
    echo "<script type='text/javascript'> document.location ='workspace.html'; </script>";
  }
  else
    {
